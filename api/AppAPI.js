...
export function loadHomeData() {
    firebase.database().ref('/entrepeneurDBMI/homescreen').on('value', (snapshot) => {
...
export function loadScheduleData() {
  firebase.database().ref('/entrepeneurDBMI/schedulescreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
...
export function loadExhibitorData() {
  firebase.database().ref('/entrepeneurDBMI/exhibitorscreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
...
export function loadSpeakerData() {
  firebase.database().ref('/entrepeneurDBMI/speakerscreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
...
export function loadTicketData() {
  firebase.database().ref('/entrepeneurDBMI/ticketscreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
